  ...
  return (
    <Tilt className='xs:w-[250px] w-full'>
      <motion.div
        ...
        className='w-full gold-magenta-gradient p-[1px] rounded-[20px] shadow-card'
      >
        <motion.div
          options={{
            max: 45,
          ...
          className='bg-sec rounded-[20px] py-5 px-12 min-h-[280px] flex justify-evenly items-center flex-col'
        >
...
export default SectionWrapper(About, "about") // HOC - About